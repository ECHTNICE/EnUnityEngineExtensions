#if !(DISABLE_ALL_EN_EXTENSIONS || DISABLE_EN_NAVMESHPATH_EXTENSIONS)
...
namespace UnityEngine {
	...
	/// #define DISABLE_EN_NAVMESHPATH_EXTENSIONS // Disable this Extensions
	/// 
	/// </code>
	/// </example>
	/// </summary>
	public static class EnNavMeshPathExtensions {
